...
- **Cute cat theme** — the theme toggle now cycles through three
  modes: ☀ Light → ☾ Dark → 🐾 Cute. Cute mode swaps in a pastel
  pink/apricot palette, rounded playful fonts (Baloo 2 / Quicksand),
  a cat face next to the "Ledger" wordmark, sticker-style die-cut
  borders on earned badges, and cat-themed badge icons (🐾 🐟 🧶 👑 🐱).
  Your choice is saved per-device, same as before.
